    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="d-flex justify-content-center custom-control custom-checkbox row">
                    <div class="col-12">
                        <input type="checkbox" id="remember_me" name="remember" style="display:none;" />
                        <label class="" for="remember_me" style="display:none;">Recordarme</label>
                    </div>
                </div>
